...
import { FiBriefcase, FiGlobe, FiPhone, FiMail, FiMapPin } from "react-icons/fi";
...
export default function OrganizationProfileForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      console.log("OrganizationProfileForm: Calling completeOrgProfile mutation");
      await completeOrgProfile({ ...formData, profileCompleted: true }).unwrap();
      console.log("OrganizationProfileForm: Profile update successful");
      toast.success("Organization profile completed successfully!");
      router.push("/dashboard");
    } catch (error) {
      console.error("OrganizationProfileForm: Profile update error:", error);
