...
import { FaHeart, FaChartLine, FaHandHoldingHeart, FaCalendarAlt, FaDownload } from "react-icons/fa";
...
export default function MyDonationsPage() {
   ...
   const avgDonation = totalDonated / donations.filter((d) => d.status === "completed").length;

   const DonationCard = ({ donation }: { donation: Donation }) => (
      <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
         <div className="flex justify-between items-start mb-4">
            <div>
               <h3 className="text-lg font-semibold text-gray-900">{donation.causeTitle}</h3>
            ...
            <span
               className={`text-xs font-medium px-2.5 py-0.5 rounded-full ${donation.status === "completed"
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
               <div className="flex items-center justify-between">
                  <div>
                     ...
                     <p className="text-2xl font-bold text-gray-900">{totalImpact} causes</p>
                  </div>
