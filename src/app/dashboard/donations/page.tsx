...
import { FaHeart, FaHandHoldingHeart, FaChartLine } from "react-icons/fa";
import { useGetDonorStatsQuery } from "@/store/api/donationApi";

const DonorStatsSection = () => {
	const { data, isLoading, isError } = useGetDonorStatsQuery();

	if (isLoading) {
		return <p className="text-gray-700 text-center py-10">Loading stats...</p>;
	}
	...
	const { totalDonated, averageDonation, totalCauses } = data.data;
...
export default DonorStatsSection;
