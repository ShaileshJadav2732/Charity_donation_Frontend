...
import { useGetDonationByIdQuery, useUpdateDonationStatusMutation } from "@/store/api/donationApi";
...
const StatusUpdatePage = () => {
   ...
   const [selectedStatus, setSelectedStatus] = useState<DonationStatus>(DonationStatus.PENDING);

   const { data: donation, isLoading, error } = useGetDonationByIdQuery(donationId);
   const [updateStatus, { isLoading: isUpdating }] = useUpdateDonationStatusMutation();
