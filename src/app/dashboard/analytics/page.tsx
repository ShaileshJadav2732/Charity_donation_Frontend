...
export default function AnalyticsDashboard() {
	...
	const monthlyDonationData = analyticsData.monthlyDonationTrends.map(
		(item) => ({
	...
	const donationTypeData = analyticsData.donationTypeDistribution.map(
		(item) => ({
			name: item._id,
			value: item.total,
			count: item.count,
		...
		<Container maxWidth="xl">
							...
							<Card>
								<CardContent>
									...
									<Box display="flex" alignItems="center" mt={1}>
										<TrendingUpIcon
											color={
												analyticsData.yearComparison.yoyGrowth >= 0
													? "success"
													: "error"
											}
											fontSize="small"
										...
										>
											{analyticsData.yearComparison.yoyGrowth.toFixed(1)}% vs
											last year
										</Typography>
									</Box>
								</CardContent>
						...
						<Grid item xs={12} sm={6} md={3}>
							<Card>
								<CardContent>
									...
									<Box display="flex" alignItems="center" mt={1}>
										<Typography variant="body2" color="text.secondary">
											{analyticsData.donorRetention.retainedDonorCount}{" "}
											returning donors
										</Typography>
									</Box>
								</CardContent>
						...
						<Grid item xs={12} sm={6} md={3}>
							<Card>
								<CardContent>
									...
									<Box display="flex" alignItems="center" mt={1}>
										<Typography variant="body2" color="text.secondary">
											From {analyticsData.feedbackSentiment.totalFeedback}{" "}
											reviews
										</Typography>
									</Box>
								</CardContent>
			...
			{activeTab === "donations" && (
				<Box p={4} textAlign="center">
					...
					<Typography variant="body2" color="text.secondary">
						Detailed donation analytics will be available here in the next
						update.
					</Typography>
				</Box>
			)}
